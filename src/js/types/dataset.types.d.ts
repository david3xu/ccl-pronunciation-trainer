 ...
 */
export type VocabularyCategory = 'pte-fib-listening' | 'pte-beginner' | 'pte-intermediate' | 'pte-advanced' | 'pte-ra' | 'pte-rs-vocab' | 'pte-must-know' | 'pte-wfd-vocab' | 'pte-rs-wfd-vocab' | 'pte-reading-fib' | 'pte-reading-fib-drag' | 'pte-asq-answers' | 'pte-high-frequency';
/**
 ...
 */
export type PracticeItem = RepeatSentenceItem | AnswerShortQuestionItem | WriteFromDictationItem;
/**
