...
class InitializationManager {
     ...
     * @returns {Promise<Object>} - Result with success, time, error
     */
        ...
        for (let attempt = 0; attempt <= retries; attempt++) {
            ...
            try {
                ...
                if (attempt < retries) {
                    ...
                    console.warn(`⚠️  ${name} failed (attempt ${attempt + 1}/${retries + 1}): ${error.message}. Retrying in ${delay}ms...`);
     ...
     * @returns {Promise} - Original promise or timeout rejection
     */
