    ...
    constructor() {
        ...
        this.config = {
            ...
            build: {
                ...
                jsFiles: [
                    'js/shared/Config.js',
                    'js/shared/DataSchema.js',
                    'js/utils/EventBus.js',
                    'js/utils/Storage.js',
                    'js/utils/CacheMigration.js',
                    'js/data/DatasetManager.js',
                    'js/core/InitializationManager.js',
                    'js/core/SettingsModule.js',
                    'js/core/PTEVocabularyManager.js',
                    'js/core/ProgressTracker.js',
                    'js/audio/TTSEngine.js',
                    'js/audio/VoiceSelector.js',
                    'js/audio/AudioControls.js',
