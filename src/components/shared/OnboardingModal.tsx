...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onClose }) => {
  ...
  const steps = [
    ...
    {
      title: '🎤 Study Modes',
      description: 'Choose from vocabulary learning or PTE task practice',
      features: [
        '📚 Vocabulary Learning: Learn words with IPA pronunciation',
        '🗣️ Repeat Sentence (RS): Practice 620 sentences',
        '❓ Answer Short Question (ASQ): Practice 692 questions',
        '✍️ Write From Dictation (WFD): Practice 1,195 sentences',
      ],
      cta: 'Next',
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        '💡 Tip: Use Settings to adjust playback speed and repeat count',
      ],
