...
export class AnalyticsDashboard {
  ...
  private async loadStatistics(): Promise<void> {
    ...
    if (!loadingEl || !statsEl || !errorEl) return;
   ...
   * Update a stat value
   */
  private updateStat(id: string, value: number | string): void {
   ...
   */
  private renderRecentSessions(sessions: any[]): void {
   ...
   */
  private formatDatasetName(datasetId: string): string {
